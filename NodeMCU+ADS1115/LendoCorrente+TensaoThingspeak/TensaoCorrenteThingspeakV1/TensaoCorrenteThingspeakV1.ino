...
unsigned int calcVI(unsigned int crossings, unsigned int timeout)
{
...
void loop() {
  ...
  unsigned int numeroDeAmostras=calcVI(20,2000);
  unsigned long fim = millis();  
  unsigned long tempoCalculo=fim-inicio;

  double amostragem = numeroDeAmostras/tempoCalculo;
 ...
 //Envia dados MQTT ao Thingspeak
  ...
  Serial.println(tempoCalculo,7);
  Serial.print("Samples: ");
  Serial.println(numeroDeAmostras,7);
